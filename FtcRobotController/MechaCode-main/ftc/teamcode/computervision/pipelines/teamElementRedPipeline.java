...
public class teamElementRedPipeline extends OpenCvPipeline {

    //use 176 by 144 pixel camera
    public static int x1 =0,x2=50,x3=60,x4=110,x5=120,x6=170,y1=0,y2=144;
    ...
    public Mat processFrame(Mat input){
        ...
        if(maxAt == 0){
            Imgproc.rectangle(input,new Point(x1 , y1),new Point(x2,y2),new Scalar(255,0,0),1);
        ...
        if(maxAt == 1){
            ...
            Imgproc.rectangle(input,new Point(x3 , y1),new Point(x4,y2),new Scalar(255,0,0),1);
        ...
        if(maxAt == 2){
            ...
            Imgproc.rectangle(input,new Point(x5 , y1),new Point(x6,y2),new Scalar(255,0,0),1);
